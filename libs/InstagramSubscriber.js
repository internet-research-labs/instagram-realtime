 ...
 */
function InstagramSubscriber (parent, client_id, client_secret, callback_url) {
 ...
 */
InstagramSubscriber.prototype.subscribe_user = function () {
  'use strict';
 ...
 * @return {undefined} undefined
 */
InstagramSubscriber.prototype.subscribe_tag = function (tag) {
  'use strict';
  var url = 'https://api.instagram.com/v1/subscriptions/';
  var data = {
    client_id     : this.client_id,
 ...
 * @return {undefined} undefined
 */
InstagramSubscriber.prototype.subscribe_location = function (id) {
  'use strict';
  var url = 'https://api.instagram.com/v1/subscriptions/';
  var data = {
    client_id     : this.client_id,
 ...
 * @return {undefined} undefined
 */
InstagramSubscriber.prototype.subscribe_geography = function (lat, lng, rad) {
 ...
 * @return {undefined} undefined
 */
InstagramSubscriber.prototype.unsubscribe = function (id) {
  'use strict';
